...
public class Util {
	 ...
	 * @param url
	 */
	public static void luanchtheurl(String url) {
	 ...
	 * @param url
	 */
	public static void luanchtheurlandverifyitstitle(WebDriver driver, String url, String expectedvalue) {
		System.out.println("your browser is launch...");
		driver.get(url);
	 ...
	 * @param expectedvalue
	 */
	public static void verifythetitleoftheprovidedpage(WebDriver driver, String expectedvalue) {
...
//	}
	 ...
	 * @param title
	 */
	public static void gobackgoforward(WebDriver driver, String userinput, String title, String URL) {
...
//==========================================XPATH=========================================
	...
	static public void datepicker(WebDriver driver, By locator, String dateneedtobepass) {
		...
		public static void domovetoelement(WebDriver driver, By locator, By locator2) {
